...
class TestFileSystemValidator:
    ...
    def test_validate_existing_sample_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            preset = {
                "Preset 1": {
                    "Name": "Test Preset",
                    "Channel 1": {"Pitch": 0.00, "Zone 1": {"Sample": "test1.wav"}},
                    "Channel 2": {"Pitch": 0.00, "Zone 1": {"Sample": "test2.wav"}},
                }
            }
    ...
    def test_invalid_sample_format(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            preset = {
                "Preset 1": {
                    "Name": "Test Preset",
                    "Channel 1": {"Pitch": 0.00, "Zone 1": {"Sample": "test.txt"}},
                }
            }
    ...
    def test_total_memory_validation(self, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Create a preset referencing these files
            preset = {"Preset 1": {"Name": "Test Preset"}}
            ...
            monkeypatch.setattr(
                "a8_validate.file_system_validator.calculate_total_memory",
